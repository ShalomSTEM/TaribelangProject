...
class Player_MLBL3(RoomObject):
    def __init__(self, room, x, y, size):
        ...
        self.size = size
        player = self.load_image(os.path.join("MilbiL3", "front_1.png"))
        self.set_image(player, 16, 24)

        # Load player animation images
        self.down = []
        self.down.append(
            self.load_image(os.path.join("MilbiL3", "front_1.png"))
        )
        self.down.append(
            self.load_image(os.path.join("MilbiL3", "front_2.png"))
        )
        self.down.append(
            self.load_image(os.path.join("MilbiL3", "front_3.png"))
        )
        self.down.append(
            self.load_image(os.path.join("MilbiL3", "front_4.png"))
        )
        self.up = []
        self.up.append(
            self.load_image(os.path.join("MilbiL3", "back_1.png"))
        )
        self.up.append(
            self.load_image(os.path.join("MilbiL3", "back_2.png"))
        )
        self.up.append(
            self.load_image(os.path.join("MilbiL3", "back_3.png"))
        )
        self.up.append(
            self.load_image(os.path.join("MilbiL3", "back_4.png"))
        )
        self.left = []
        self.left.append(
            self.load_image(os.path.join("MilbiL3", "left_1.png"))
        )
        self.left.append(
            self.load_image(os.path.join("MilbiL3", "left_2.png"))
        )
        self.left.append(
            self.load_image(os.path.join("MilbiL3", "left_3.png"))
        )
        self.left.append(
            self.load_image(os.path.join("MilbiL3", "left_4.png"))
        )
        self.right = []
        self.right.append(
            self.load_image(os.path.join("MilbiL3", "right_1.png"))
        )
        self.right.append(
            self.load_image(os.path.join("MilbiL3", "right_2.png"))
        )
        self.right.append(
            self.load_image(os.path.join("MilbiL3", "right_3.png"))
        )
        self.right.append(
            self.load_image(os.path.join("MilbiL3", "right_4.png"))
        )
    ...
    def move_right(self):
        ...
        if self.x < 600:
            self.set_image(
                os.path.join("Images", "MilbiL3", "right_2.png"), self.size, self.size
            )
        Globals.player_x += 1
    ...
    def move_left(self):
        ...
        if self.x > 200:
            self.set_image(
                os.path.join("Images", "MilbiL3", "left_2.png"), self.size, self.size
            )
        if self.x > 200:
            self.x -= self.move_speed
        else:
    ...
    def move_up(self):
        self.move_speed = 8
        self.set_image(
            os.path.join("Images", "MilbiL3", "back_2.png"), self.size, self.size
        )
    ...
    def move_down(self):
        self.move_speed = 8
        self.set_image(
            os.path.join("Images", "MilbiL3", "front_2.png"), self.size, self.size
        )
        Globals.player_y += 1
        if self.y < 450:
            self.y += self.move_speed
